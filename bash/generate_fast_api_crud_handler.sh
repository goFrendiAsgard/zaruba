...
generate_fast_api_crud_handler() {
    ...
    _SNAKE_SERVICE_NAME=$("${ZARUBA_HOME}/zaruba" str snake "${SERVICE_NAME}")
    _UPPER_SNAKE_SERVICE_NAME=$("${ZARUBA_HOME}/zaruba" str upper "${SERVICE_NAME}")
    _PASCAL_SERVICE_NAME=$("${ZARUBA_HOME}/zaruba" str pascal "${SERVICE_NAME}")
    _CAMEL_MODULE_NAME=$("${ZARUBA_HOME}/zaruba" str camel "${MODULE_NAME}")
    _PASCAL_MODULE_NAME=$("${ZARUBA_HOME}/zaruba" str pascal "${MODULE_NAME}")
    _SNAKE_MODULE_NAME=$("${ZARUBA_HOME}/zaruba" str snake "${MODULE_NAME}")
    _CAMEL_ENTITY_NAME=$("${ZARUBA_HOME}/zaruba" str camel "${ENTITY_NAME}")
    _PASCAL_ENTITY_NAME=$("${ZARUBA_HOME}/zaruba" str pascal "${ENTITY_NAME}")
    _SNAKE_ENTITY_NAME=$("${ZARUBA_HOME}/zaruba" str snake "${ENTITY_NAME}")
    ...
    _SNAKE_FIRST_FIELD_NAME=$("${ZARUBA_HOME}/zaruba" str snake "${_FIRST_FIELD_NAME}")
    ...
    do
        ...
        _SNAKE_FIELD_NAME="$("${ZARUBA_HOME}/zaruba" str snake "${_FIELD_NAME}")"
