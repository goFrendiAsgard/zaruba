...
def test_main_project_update_env():
    ...
    service_project.generate(dir_name=dir_name, service_name=service_name, image_name='myImage', container_name='myContainer', location=app_location, start_command='node main.js', port_list=[], env_list=[], runner_version='')
