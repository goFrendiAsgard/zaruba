...
def create_service_task(template_location: str, service_name: str, image_name: str, container_name: str, location: str, start_command: str='', ports: str='', envs: str='', runner_version: str=''):
    ...
    service_project.generate(dir_name=dir_name, service_name=service_name, image_name=image_name, container_name=container_name, location=location, start_command=start_command, port_list=port_list, env_list=env_list, runner_version=runner_version)
