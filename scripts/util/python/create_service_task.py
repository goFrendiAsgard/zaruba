...
@cli
def create_service_task(templates: str = '', location: str = '.', service_type: str = '', ports: str = ''):
    ...
    run_task_name = generator.get_run_task_name(location)
    ...
    service_name = generator.get_service_name(location)
