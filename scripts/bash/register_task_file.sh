...
register_task_file() {
   ...
   _PASCAL_SERVICE_NAME="$("${ZARUBA_HOME}/zaruba" strToPascal "${_SERVICE_NAME}")" 
    ...
    "${ZARUBA_HOME}/zaruba" includeFileToProject "./main.zaruba.yaml" "${_TASK_FILE_NAME}"
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "buildImage" "[\"build${_PASCAL_SERVICE_NAME}Image\"]"
    fi
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "pullImage" "[\"pull${_PASCAL_SERVICE_NAME}Image\"]"
    fi
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "pushImage" "[\"push${_PASCAL_SERVICE_NAME}Image\"]"
    fi
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "run" "[\"run${_PASCAL_SERVICE_NAME}\"]"
        ...
        then
            "${ZARUBA_HOME}/zaruba" ensureTaskExist "./main.zaruba.yaml" "runContainer"
            "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "runContainer" "[\"run${_PASCAL_SERVICE_NAME}\"]"
        fi
    fi
    ...
    then
        "${ZARUBA_HOME}/zaruba" ensureTaskExist "./main.zaruba.yaml" "runContainer"
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "runContainer" "[\"run${_PASCAL_SERVICE_NAME}Container\"]"
    fi 
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "stopContainer" "[\"stop${_PASCAL_SERVICE_NAME}Container\"]"
    fi
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "removeContainer" "[\"remove${_PASCAL_SERVICE_NAME}Container\"]"
    fi
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "helmInstall" "[\"helmInstall${_PASCAL_SERVICE_NAME}\"]"
    fi
    ...
    then
        ...
        "${ZARUBA_HOME}/zaruba" addTaskDependency "./main.zaruba.yaml" "helmUninstall" "[\"helmUninstall${_PASCAL_SERVICE_NAME}\"]"
    fi
}