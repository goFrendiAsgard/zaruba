...
var insertLineBeforeIndexCmd = &cobra.Command{
	Use:   "insertLineBeforeIndex <lines> <index> <newLine>",
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		result, err := str.ReplaceLineAtIndex(lines, index, append(newLines, lines[index]))
		if err != nil {
			exit(commandName, logger, decoration, err)
		}
...
func init() {
	rootCmd.AddCommand(insertLineBeforeIndexCmd)
}
