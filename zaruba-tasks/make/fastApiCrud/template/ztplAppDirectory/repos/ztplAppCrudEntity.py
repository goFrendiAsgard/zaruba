...
class MemZtplAppCrudEntityRepo(ZtplAppCrudEntityRepo):
    ...
    def find(self, keyword: str, limit: int, offset: int) -> List[ZtplAppCrudEntity]:
        mem_ztpl_app_crud_entities = self._ztpl_app_crud_entity_map.values()
    ...
    def insert(self, ztpl_app_crud_entity_data: ZtplAppCrudEntityData) -> ZtplAppCrudEntityRepo:
        ...
        self._ztpl_app_crud_entity_map[id] = new_ztpl_app_crud_entity

    def update(self, id: str, ztpl_app_crud_entity_data: ZtplAppCrudEntityData) -> ZtplAppCrudEntityRepo:
