...
_NEW_FUNCTION_LINE="${_FUNCTION_INDENTATION}def register_rpc_handler(${_FUNCTION_PARAM}, ${_ZRB_APP_SNAKE_CRUD_ENTITY}_repo: ${_ZRB_APP_PASCAL_CRUD_ENTITY}Repo)${_FUNCTION_SUFFIX}"
