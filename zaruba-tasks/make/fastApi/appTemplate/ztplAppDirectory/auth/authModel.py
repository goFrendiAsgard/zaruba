...
class AuthModel(abc.ABC):
    ...
    @abc.abstractmethod
    def has_all_permissions(self, *permissions: str) -> Callable[[Request], User]:
        pass
...
class TokenOAuth2AuthModel(AuthModel):
    ...
    def __init__(self, user_model: UserModel, token_model: TokenModel, oauth2_scheme: OAuth2, root_permission: str):
        self.user_model = user_model
