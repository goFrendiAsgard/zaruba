...
_DB_FIELD_SCRIPT_TEMPLATE="$(cat "${ZARUBA_HOME}/zaruba-tasks/make/fastAppCrud/partials/repo_field_update_db.py")"
_DB_FIELD_SCRIPT_LINES='[]'
_MEM_FIELD_SCRIPT_TEMPLATE="$(cat "${ZARUBA_HOME}/zaruba-tasks/make/fastAppCrud/partials/repo_field_update_mem.py")"
