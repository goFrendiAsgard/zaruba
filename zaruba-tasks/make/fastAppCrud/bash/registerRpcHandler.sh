...
_HANDLE_RPC_SCRIPT="$(cat "${ZARUBA_HOME}/zaruba-tasks/make/fastAppCrud/partials/handle_rpc.py")"
...
_NEW_FUNCTION_LINE="${_FUNCTION_INDENTATION}def register_${_ZRB_SNAKE_APP_MODULE_NAME}_rpc_handler(${_FUNCTION_PARAM}, ${_ZRB_SNAKE_APP_CRUD_ENTITY}_service: ${_ZRB_PASCAL_APP_CRUD_ENTITY}Service)${_FUNCTION_SUFFIX}"
