    ...
    export default {
        ...
        methods: {
            ...
            async _getRow(id) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot get ztplAppCrudEntity ${id}`));
            },
            ...
            async _insertRow(row) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot create ztplAppCrudEntity ${id}`));
            },
            ...
            async _updateRow(id, row) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot update ztplAppCrudEntity ${id}`));
            },
            ...
            async _deleteRow(id) {
                ...
                throw new Error(appHelper.getResponseErrorMessage(response, `Cannot delete ztplAppCrudEntity ${id}`));
            },
            ...
            async showInsertForm() {
                this.formTitle = 'New ZtplAppCrudEntity';
            ...
            async showUpdateForm(id) {
                try {
                    ...
                    this.formTitle = `Edit ZtplAppCrudEntity ${id}`;
            ...
            async confirmDelete(id) {
                try {
                    const confirmation = await appHelper.confirm(`Are you sure to delete ztplAppCrudEntity ${id}?`);
                    if (!confirmation) {
                        return;
                    }
