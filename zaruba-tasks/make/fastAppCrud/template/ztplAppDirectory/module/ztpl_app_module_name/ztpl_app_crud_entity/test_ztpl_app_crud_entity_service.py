from module.ztpl_app_module_name.ztpl_app_crud_entity.test_ztpl_app_crud_entity_service_util import (
    create_ztpl_app_crud_entity_data,
    insert_ztpl_app_crud_entity_data,
    init_test_ztpl_app_crud_entity_service_components
)
...
def test_ztpl_app_crud_entity_service_crud_find_by_id_existing():
    ...
    # prepare repo
    existing_ztpl_app_crud_entity = insert_ztpl_app_crud_entity_data(
        ztpl_app_crud_entity_repo)
    # test find by id (existing)
    fetched_ztpl_app_crud_entity = ztpl_app_crud_entity_service.find_by_id(
        existing_ztpl_app_crud_entity.id, AUTHORIZED_ACTIVE_USER)
...
def test_ztpl_app_crud_entity_service_crud_find_by_id_non_existing():
    ...
    is_error = False
    try:
        ztpl_app_crud_entity_service.find_by_id(
...
def test_ztpl_app_crud_entity_service_crud_find_existing():
    ...
    # test find (existing)
    fetched_ztpl_app_crud_entity_result = ztpl_app_crud_entity_service.find(
        keyword='ztplAppCrudEntity',
        limit=100,
        offset=0,
...
def test_ztpl_app_crud_entity_service_crud_find_non_existing():
    ...
    non_existing_ztpl_app_crud_entity_result = ztpl_app_crud_entity_service.find(
...
def test_ztpl_app_crud_entity_service_crud_find_pagination():
    ...
    # test find (page 1)
    fetched_ztpl_app_crud_entity_result = ztpl_app_crud_entity_service.find(
        keyword='ztplAppCrudEntity', limit=3, offset=0,
        current_user=AUTHORIZED_ACTIVE_USER
    )
    ...
    # test find (page 2)
    fetched_ztpl_app_crud_entity_result = ztpl_app_crud_entity_service.find(
        keyword='ztplAppCrudEntity', limit=3, offset=3,
        current_user=AUTHORIZED_ACTIVE_USER
    )
    assert len(fetched_ztpl_app_crud_entity_result.rows) == 3
    assert fetched_ztpl_app_crud_entity_result.count == 7
    # test find (page 3)
    fetched_ztpl_app_crud_entity_result = ztpl_app_crud_entity_service.find(
        keyword='ztplAppCrudEntity', limit=3, offset=6,
        current_user=AUTHORIZED_ACTIVE_USER
    )
...
def test_ztpl_app_crud_entity_service_crud_insert():
    ...
    # test insert
    inserted_ztpl_app_crud_entity = ztpl_app_crud_entity_service.insert(
        inserted_ztpl_app_crud_entity_data, AUTHORIZED_ACTIVE_USER
    )
...
def test_ztpl_app_crud_entity_service_crud_update_existing():
    ...
    updated_ztpl_app_crud_entity = ztpl_app_crud_entity_service.update(
        existing_ztpl_app_crud_entity.id,
        updated_ztpl_app_crud_entity_data,
...
def test_ztpl_app_crud_entity_service_crud_update_non_existing():
    ...
    is_error = False
    try:
        ztpl_app_crud_entity_service.update(
            'invalid-id',
            updated_ztpl_app_crud_entity_data,
            AUTHORIZED_ACTIVE_USER
        )
...
def test_ztpl_app_crud_entity_service_crud_delete_non_existing():
    ...
    is_error = False
    try:
        ztpl_app_crud_entity_service.delete(
            'invalid-id', AUTHORIZED_ACTIVE_USER
        )
    except Exception:
        is_error = True
