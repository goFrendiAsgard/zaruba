...
def register_ztpl_app_crud_entity_rpc(mb: AppMessageBus, rpc: AppRPC, auth_service: AuthService, ztpl_app_crud_entity_service: ZtplAppCrudEntityService):
    ...
    def find_ztpl_app_crud_entity_by_id(
        ...
        return _ztpl_app_crud_entity_as_dict(ztpl_app_crud_entity)
    ...
    def insert_ztpl_app_crud_entity(
        ...
        return _ztpl_app_crud_entity_as_dict(new_ztpl_app_crud_entity)
    ...
    def update_ztpl_app_crud_entity(
        ...
        return _ztpl_app_crud_entity_as_dict(updated_ztpl_app_crud_entity)
    ...
    def delete_ztpl_app_crud_entity(
        ...
        return _ztpl_app_crud_entity_as_dict(deleted_ztpl_app_crud_entity)
    ...
    def _ztpl_app_crud_entity_as_dict(
