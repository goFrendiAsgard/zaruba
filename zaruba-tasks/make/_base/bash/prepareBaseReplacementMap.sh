...
_setReplacementMap "ztpl_app_crud_field" "${_ZRB_SNAKE_APP_CRUD_FIELD}"
_setReplacementMap "ztplAppCrudField" "${_ZRB_APP_CRUD_FIELD}"
_setReplacementMap "ztpl-app-crud-field" "${_ZRB_KEBAB_APP_CRUD_FIELD}"
_setReplacementMap "ZtplAppCrudField" "${_ZRB_PASCAL_APP_CRUD_FIELD}"
...
_setReplacementMap "ZTPL_APP_MODULE_NAME" "${_ZRB_UPPER_SNAKE_APP_MODULE_NAME}"
...
_setReplacementMap "ztpl-normalized-app-url" "${_ZRB_NORMALIZED_APP_URL}"
_setReplacementMap "ZtplAppUrl" "${_ZRB_PASCAL_APP_URL}"
_setReplacementMap "ZtplAppUrlTitle" "${_ZRB_APP_URL_TITLE}"
