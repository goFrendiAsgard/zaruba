...
_REGISTER_UI_SCRIPT="$(cat "${ZARUBA_HOME}/zaruba-tasks/make/fastApiModule/partials/register_ui.py")"
_REGISTER_UI_SCRIPT="$("${ZARUBA_BIN}" str replace "${_REGISTER_UI_SCRIPT}" "${_ZRB_REPLACEMENT_MAP}" )"

_CREATE_MENU_SERVICE_FILE_LOCATION="${_ZRB_APP_DIRECTORY}/ui/createMenuService.py"
