...
def test_content_service_crud_find_by_id_existing():
    content_service, content_repo, _, _ = init_test_content_service_components()
    # prepare repo
    existing_content = insert_content_data(content_repo)
...
def test_content_service_crud_find_by_id_non_existing():
    content_service, content_repo, _, _ = init_test_content_service_components()
    # prepare repo
    insert_content_data(content_repo)
...
def test_content_service_crud_find_pagination():
    ...
    for index in range(7):
        insert_content_data(content_repo, index)
    # test find (page 1)
...
def test_content_service_crud_insert():
    content_service, content_repo, _, _ = init_test_content_service_components()
    # prepare insert
    inserted_content_data = create_content_data()
...
def test_content_service_crud_update_existing():
    ...
    updated_content_data = create_content_data()
