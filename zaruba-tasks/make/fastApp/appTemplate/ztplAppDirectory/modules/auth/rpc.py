...
def register_auth_rpc_handler(mb: MessageBus, rpc: RPC, role_service: RoleService, user_service: UserService, token_service: TokenService, session_service: SessionService):
    register_session_rpc(mb, rpc, session_service)
    register_token_rpc(mb, rpc, token_service)
