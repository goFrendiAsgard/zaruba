...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_content_types_attributes'), 'content_types', ['json_attributes'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_content_types_attributes'), table_name='content_types')
