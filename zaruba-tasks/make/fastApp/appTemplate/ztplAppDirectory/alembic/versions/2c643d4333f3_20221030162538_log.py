...
def upgrade() -> None:
    ...
    op.create_table('activities',
        ...
        sa.Column('row', sa.String(length=255), nullable=True),
    ...
    op.create_index(op.f('ix_activities_row'), 'activities', ['row'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_activities_row'), table_name='activities')
