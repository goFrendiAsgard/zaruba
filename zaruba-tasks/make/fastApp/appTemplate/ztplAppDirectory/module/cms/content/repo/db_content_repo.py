...
class DBContentRepo(ContentRepo):
    ...
    def find_by_id(self, id: str) -> Optional[Content]:
        ...
        content: Content
        try:
            db_content = db.query(DBContentEntity).filter(
                DBContentEntity.id == id
            ).first()
    ...
    def find(self, keyword: str, limit: int, offset: int) -> List[Content]:
        ...
        try:
            ...
            contents = [
                self._from_db_content(db_content) for db_content in db_contents
            ]
        finally:
            db.close()
        return contents
    ...
    def insert(self, content_data: ContentData) -> Optional[Content]:
        ...
        content: Content
        try:
            content_attributes = self._map_to_attributes(
    ...
    def update(self, id: str, content_data: ContentData) -> Optional[Content]:
        ...
        try:
            ...
            db_content.updated_at = datetime.datetime.utcnow()  # Note: 🤖 Don't delete this line
    ...
    def _from_db_content(self, db_content: DBContentEntity) -> Content:
        ...
        content.attributes = self._attributes_to_map(
            db_content.content_attributes
        )
        return content

    def _map_to_attributes(
