...
from module.cms.content_type import ContentTypeService
...
class ContentTypeSeederService():
    ...
    def seed(
        ...
        try:
            self.content_type_service.find_by_name(
                content_type.name, system_user
            )
        except HTTPException as error:
            if error.status_code == 404:
                self.content_type_service.insert(
                    content_type, system_user
                )
