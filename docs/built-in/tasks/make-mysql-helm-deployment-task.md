...
File Location:
    ...
    ${ZARUBA_HOME}zaruba-tasks/make/mysqlHelmDeployment/task.makeMysqlHelmDeploymentTask.yaml
...
Value:
    ...
    [
      "{{ .ZarubaHome }}/zaruba-tasks/make/mysqlHelmDeployment/deploymentTaskTemplate"
    ]
