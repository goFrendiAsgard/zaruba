...
File Location:
    ...
    /home/gofrendi/zaruba/zaruba-tasks/make/fastAppRpcHandler/task.addFastAppRpcHandler.yaml
...
Value:
    ...
    . "{{ .ZarubaHome }}/zaruba-tasks/make/fastAppRpcHandler/bash/addRpcHandler.sh"
