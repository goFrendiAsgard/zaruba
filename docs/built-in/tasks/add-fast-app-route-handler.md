...
File Location:
    ...
    /home/gofrendi/zaruba/zaruba-tasks/make/fastAppRouteHandler/task.addFastAppRouteHandler.yaml
...
Value:
    ...
    . "{{ .ZarubaHome }}/zaruba-tasks/make/fastAppRouteHandler/bash/addRouteHandler.sh"
