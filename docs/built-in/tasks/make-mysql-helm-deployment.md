...
File Location:
    ...
    /home/gofrendi/zaruba/zaruba-tasks/make/mysqlHelmDeployment/task.makeMysqlHelmDeployment.yaml
...
Value:
    ...
    [
      "{{ .ZarubaHome }}/zaruba-tasks/make/mysqlHelmDeployment/deploymentTemplate"
    ]
