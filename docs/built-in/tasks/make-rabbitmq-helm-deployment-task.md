...
File Location:
    ...
    ${ZARUBA_HOME}zaruba-tasks/make/rabbitmqHelmDeployment/task.makeRabbitmqHelmDeploymentTask.yaml
...
Value:
    ...
    . "{{ .ZarubaHome }}/zaruba-tasks/make/_base/bash/registerDeploymentTasks.sh" "${_ZRB_DEPLOYMENT_NAME}"
...
Value:
    ...
    [
      "{{ .ZarubaHome }}/zaruba-tasks/make/rabbitmqHelmDeployment/deploymentTaskTemplate"
    ]
