...
File Location:
    ...
    /home/gofrendi/zaruba/zaruba-tasks/make/rabbitmqHelmDeployment/task.makeRabbitmqHelmDeployment.yaml
...
Value:
    ...
    [
      "{{ .ZarubaHome }}/zaruba-tasks/make/rabbitmqHelmDeployment/deploymentTemplate"
    ]
