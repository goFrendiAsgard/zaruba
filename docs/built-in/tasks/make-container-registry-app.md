...
File Location:
    ...
    /home/gofrendi/zaruba/zaruba-tasks/make/containerRegistry/task.makeContainerRegistryApp.yaml
...
Value:
    ...
    [
      "{{ .ZarubaHome }}/zaruba-tasks/make/containerRegistry/appTemplate"
    ]
