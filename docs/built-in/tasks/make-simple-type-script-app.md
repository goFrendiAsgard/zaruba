...
File Location:
    ...
    /home/gofrendi/zaruba/zaruba-tasks/make/simpleTypeScriptApp/task.makeSimpleTypeScriptApp.yaml
...
Value:
    ...
    [
      "{{ .ZarubaHome }}/zaruba-tasks/make/simpleTypeScriptApp/appTemplate"
    ]
