...
* [🧠 Core Concept](core-concept/README.md)
    * [🏗️ Project](core-concept/project/README.md)
        ...
        * [Includes](core-concept/project/includes.md)
        * [Project Inputs](core-concept/project/project-inputs.md)
        * [Project Configs](core-concept/project/project-configs.md)
        * [Project Envs](core-concept/project/project-envs.md)
        * [Task](core-concept/project/task/README.md)
            ...
            * [Extend task](core-concept/project/task/extend-task.md)
            * [Define task dependencies](core-concept/project/task/define-task-dependencies.md)
        * [Using Go Template](core-concept/project/using-go-template.md)
* [👷🏽 Use Cases](use-cases/README.md)
    ...
    * [Add EKS Deployment](use-cases/add-third-party-service/add-eks-deployment.md)
