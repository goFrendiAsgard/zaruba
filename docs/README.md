...
- [🔧 Utilities](utilities/README.md)
  ...
  - [📁 File](utilities/file/README.md)
    ...
    - [GetLine](utilities/file/get-line.md)
    - [GetLineIndex](utilities/file/get-line-index.md)
    - [InsertBefore](utilities/file/insert-before.md)
    - [InsertAfter](utilities/file/insert-after.md)
  ...
  - [🔠 Str](utilities/str/README.md)
    ...
    - [CurrentTime](utilities/str/current-time.md)
    - [DecodeBase64](utilities/str/decode-base64.md)
    - [DoubleQuote](utilities/str/double-quote.md)
    - [EncodeBase64](utilities/str/encode-base64.md)
...
- [🥝 Core Tasks](core-tasks/README.md)
  ...
  - [🟨 addClickhouse](core-tasks/add-clickhouse.md)
  ...
  - [📙 addEc2Deployment](core-tasks/add-ec2-deployment.md)
  ...
  - [🧪 addMaterialize](core-tasks/add-materialize.md)
  ...
  - [🚢 addRabbitmqHelmDeployment](core-tasks/add-rabbitmq-helm-deployment.md)
  ...
  - [🟨 makeClickhouseApp](core-tasks/make-clickhouse-app.md)
  - [🟨 makeClickhouseAppRunner](core-tasks/make-clickhouse-app-runner.md)
  ...
  - [📙 makeEc2Deployment](core-tasks/make-ec2-deployment.md)
  - [📙 makeEc2DeploymentTask](core-tasks/make-ec2-deployment-task.md)
  ...
  - [⚛️ makeFastApp](core-tasks/make-fast-app.md)
  - [⚛️ makeFastAppRunner](core-tasks/make-fast-app-runner.md)
  ...
  - [🧪 makeMaterializeApp](core-tasks/make-materialize-app.md)
  - [🧪 makeMaterializeAppRunner](core-tasks/make-materialize-app-runner.md)
  ...
  - [🚢 makeRabbitmqHelmDeployment](core-tasks/make-rabbitmq-helm-deployment.md)
  - [🚢 makeRabbitmqHelmDeploymentTask](core-tasks/make-rabbitmq-helm-deployment-task.md)
