# makeSimplePythonAppHelmTask
```
  TASK NAME     : makeSimplePythonAppHelmTask
  LOCATION      : /zaruba-tasks/make/simplePythonApp/task.makeSimplePythonAppHelmTask.yaml
  TASK TYPE     : Command Task
  PARENT TASKS  : [ zrbMakeHelmTask ]
  DEPENDENCIES  : [ makeSimplePythonAppHelm, makeSimplePythonAppRunner ]
  START         : - {{ .GetConfig "cmd" }}
                  - {{ .GetConfig "cmdArg" }}
