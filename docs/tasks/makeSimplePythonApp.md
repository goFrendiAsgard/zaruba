# makeSimplePythonApp
```
  TASK NAME     : makeSimplePythonApp
  LOCATION      : /zaruba-tasks/make/simplePythonApp/task.makeSimplePythonApp.yaml
  ...
  CONFIG        : _finish                      : Blank
                  ...
                  start                        : Blank
                  templateLocations            : [
                                                   "{{ .ZarubaHome }}/zaruba-tasks/make/simplePythonApp/appTemplate"
                                                 ]
