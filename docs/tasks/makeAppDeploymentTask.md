...
```
  ...
  CONFIG        : _finish                       : Blank
                  ...
                  _registerTasks                : . "{{ .ZarubaHome }}/zaruba-tasks/make/task/bash/registerTasks.sh" "${_ZRB_PROJECT_FILE_NAME}" "${_ZRB_APP_NAME}"
                  ...
                  strictMode                    : true
                  templateLocation              : [
                                                    "{{ .ZarubaHome }}/zaruba-tasks/make/appDeploymentTaskTemplate" }}"
                                                  ]
