# makePythonAppHelmTask
```
  TASK NAME     : makePythonAppHelmTask
  LOCATION      : /zaruba-tasks/make/pythonAppRunner/task.makePythonAppHelmTask.yaml
  TASK TYPE     : Command Task
  PARENT TASKS  : [ zrbMakeHelmTask ]
  DEPENDENCIES  : [ makePythonAppHelm, makePythonAppRunner ]
  START         : - {{ .GetConfig "cmd" }}
                  - {{ .GetConfig "cmdArg" }}
