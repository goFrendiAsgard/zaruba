...
```
  ...
  LOCATION      : /zaruba-tasks/make/_task/_base/task.zrbMakeTask.yaml
  ...
  CONFIG        : _finish                       : Blank
                  ...
                  _registerTasks                : . "{{ .ZarubaHome }}/zaruba-tasks/make/_task/_base/bash/registerTasks.sh" "${_ZRB_PROJECT_FILE_NAME}" "${_ZRB_APP_NAME}"
