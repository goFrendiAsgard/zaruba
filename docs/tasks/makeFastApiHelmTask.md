# makeFastApiHelmTask
```
  TASK NAME     : makeFastApiHelmTask
  LOCATION      : /zaruba-tasks/make/fastApi/task.makeFastApiHelmTask.yaml
  TASK TYPE     : Command Task
  PARENT TASKS  : [ zrbMakeHelmTask ]
  DEPENDENCIES  : [ makeFastApiHelm, makeFastApiAppRunner ]
  START         : - {{ .GetConfig "cmd" }}
                  - {{ .GetConfig "cmdArg" }}
  ...
  CONFIG        : _finish                      : Blank
                  ...
                  defaultAppDirectory          : {{ .ProjectName }}FastApiHelm
