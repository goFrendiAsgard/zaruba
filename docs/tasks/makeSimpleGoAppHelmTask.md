# makeSimpleGoAppHelmTask
```
  TASK NAME     : makeSimpleGoAppHelmTask
  LOCATION      : /zaruba-tasks/make/simpleGoApp/task.makeSimpleGoAppHelmTask.yaml
  TASK TYPE     : Command Task
  PARENT TASKS  : [ zrbMakeHelmTask ]
  DEPENDENCIES  : [ makeSimpleGoAppHelm, makeSimpleGoAppRunner ]
  START         : - {{ .GetConfig "cmd" }}
                  - {{ .GetConfig "cmdArg" }}
