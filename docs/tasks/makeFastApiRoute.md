...
```
  ...
  CONFIG        : _setup                  : set -e
                  ...
                  start                   : {{- $d := .Decoration -}}
                                            ...
                                            HANDLE_ROUTE_PARTIAL=$({{ .Zaruba }} strIndent "${HANDLE_ROUTE_PARTIAL}" "    ")
                                            CONTROLLER_LINES=$({{ .Zaruba }} insertLineAfterIndex "${CONTROLLER_LINES}" "${LINE_INDEX}" "${HANDLE_ROUTE_PARTIAL}" )
