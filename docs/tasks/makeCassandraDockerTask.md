...
```
  TASK NAME     : makeCassandraDockerTask
  LOCATION      : ${ZARUBA_HOME}/scripts/tasks/makeCassandraDockerTask.zaruba.yaml
  ...
  CONFIG        : _setup                       : set -e
                  ...
                  templateLocation             : {{ .GetEnv "ZARUBA_HOME" }}/scripts/templates/task/docker/cassandra
