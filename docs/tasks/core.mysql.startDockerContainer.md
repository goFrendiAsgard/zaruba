...
```
  ...
  LOCATION      : ${ZARUBA_HOME}/scripts/tasks/core.mysql.startDockerContainer.zaruba.yaml
  ...
  CONFIG        : RunInLocal                     : true
                  ...
                  _start.runContainer            : {{ $d := .Decoration -}}
                                                   ...
                                                   {{ .GetConfig "_start.runContainer.entryPoint" -}}
                  ...
                  _start.runContainer.entryPoint : {{ if .GetConfig "entryPoint" -}}
                  ...
                  beforeStart                    : Blank
                  check                          : Blank
                  checkCommand                   : mysql -u "root" -p{{ .GetEnv "MYSQL_ROOT_PASSWORD" }} -e "SHOW SCHEMAS"
