...
Value:
    ...
    "{{ .ZarubaBin }}" project setValue "subrepo::${NAME}::prefix" "${PREFIX}" "{{ .GetWorkPath "default.values.yaml" }}" 
    "{{ .ZarubaBin }}" project setValue "subrepo::${NAME}::url" "${URL}" "{{ .GetWorkPath "default.values.yaml" }}" 
