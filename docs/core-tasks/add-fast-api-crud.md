...
[1m[34mFile Location[0m:
    ...
    ~/.zaruba/zaruba-tasks/make/fastApiCrud/task.addFastApiCrud.yaml
...
[1m[33m### Inputs.appCrudEntity[0m
...
[1m[33m### Inputs.appCrudFields[0m
...
[1m[33m### Inputs.appModuleName[0m
